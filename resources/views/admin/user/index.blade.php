                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'firstname'">{{ trans('admin.user.columns.firstname') }}</th>
                                        ...
                                        <th is='sortable' :column="'picturetitle'">{{ trans('admin.user.columns.picturetitle') }}</th>
                                        <th is='sortable' :column="'picturepath'">{{ trans('admin.user.columns.picturepath') }}</th>
                                        <th is='sortable' :column="'type_id'">{{ trans('admin.user.columns.type_id') }}</th>
