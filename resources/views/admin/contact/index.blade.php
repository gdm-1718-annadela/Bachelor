                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">{{ trans('admin.contact.columns.id') }}</th>
                                        <th is='sortable' :column="'comment'">{{ trans('admin.contact.columns.comment') }}</th>
                                        <th is='sortable' :column="'user_id'">{{ trans('admin.contact.columns.user_id') }}</th>
